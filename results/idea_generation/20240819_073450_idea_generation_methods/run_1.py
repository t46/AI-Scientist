...
archived_results_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "archived_results", EXPERIMENT)
...
ideas = generate_ideas(
    ...
    creativity_level="high"  # Increase creativity
)
